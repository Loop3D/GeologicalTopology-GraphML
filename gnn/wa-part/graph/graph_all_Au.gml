...
graph [
  ...
  node [
    id 22
    LabelGraphics [ text "Ashburton Formation[2]" fontSize 14 ]
    gid -1
  ...
  node [
    id 20
    LabelGraphics [ text "Bellary Formation[1]" fontSize 14 ]
    gid -3
  ...
  node [
    id 12
    LabelGraphics [ text "Milli Milli Inlier greenstones[2]" fontSize 14 ]
    gid -15
    graphics [ fill "#55ff55" w 150 ]
  ]
  node [
  ...
  node [
    id 21
    LabelGraphics [ text "Mount McGrath Formation[3]" fontSize 14 ]
    gid -1
    graphics [ fill "#00ff00" w 150 ]
  ]
  node [
